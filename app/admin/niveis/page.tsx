...
import { Edit, Plus, Trash2, Zap, Star, TrendingUp, DollarSign, Sparkles } from "lucide-react"
...
export default function NiveisPage() {
  ...
  return (
    <div className="min-h-screen px-6 space-y-6 bg-slate-200 pt-0 pl-0 pr-0">
      <PageHeader
        title="Níveis de Agência"
        description="Configure os níveis de gamificação baseados no MRR (Monthly Recurring Revenue)"
        action={
          <Button
                      ...
                      <div>
                        <CardTitle className="flex items-center gap-2 text-lg text-white">
                          ...
                          <Badge className="bg-gradient-to-r from-green-600 to-emerald-600 text-white border-0 shadow-md shadow-green-500/30">
                            <Zap className="h-3 w-3 mr-1" />+{level.commission_bonus}% comissão
                          </Badge>
                        </CardTitle>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all duration-300 shadow-sm">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Label className="text-xs font-medium text-gray-200">Faixa de MRR</Label>
                      </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all duration-300 shadow-sm">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Label className="text-xs font-medium text-gray-200">Bônus de Comissão</Label>
                      </div>
                      <div className="text-sm font-bold text-green-300">+{level.commission_bonus}%</div>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 border border-white/20 hover:border-white/30 transition-all duration-300 shadow-sm">
                      <div className="flex items-center gap-2 mb-1">
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-white border-gray-200">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-600">
              Configure os critérios e benefícios do nível de agência
            </DialogDescription>
          </DialogHeader>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <Label htmlFor="min_mrr" className="text-gray-700">
            MRR Mínimo
          </Label>
          <Input
            id="min_mrr"
        ...
        <div>
          <Label htmlFor="max_mrr" className="text-gray-700">
            MRR Máximo
          </Label>
          <Input
            id="max_mrr"
        ...
        <div>
          <Label htmlFor="commission_bonus" className="text-gray-700">
            Bônus Comissão (%)
          </Label>
          <Input
            id="commission_bonus"
