...
export function AgenciasDashboard() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Dashboard Agência Partner</h1>
          <p className="text-gray-600 mt-1">Escale suas operações com privilégios exclusivos do programa Partner.</p>
        </div>
