...
const defaultWidgets: Widget[] = [
  {
    id: "total-nomads",
    title: "Total de Nômades",
    value: "456",
    subtitle: "Nômades cadastrados",
    change: "+8.2%",
    icon: Users,
    color: "from-blue-500 to-blue-600",
    visible: true,
    description: "Total de nômades cadastrados na plataforma",
  },
  {
    id: "active-90d",
    title: "Nômades Ativos (90d)",
    value: "342",
    ...
    visible: true,
    description: "Nômades que completaram tarefas nos últimos 90 dias",
  },
  {
    id: "avg-rating",
    title: "Avaliação Média",
    value: "4.6",
    subtitle: "Rating geral",
    change: "+0.2 pts",
    icon: Star,
    color: "from-yellow-500 to-yellow-600",
    visible: true,
    description: "Avaliação média de todos os nômades ativos",
  },
  {
    id: "total-earnings",
    title: "Ganhos Totais",
    ...
    visible: true,
    description: "Total de ganhos dos nômades no último mês",
  },
  {
    id: "man",
    title: "MAN",
    value: "298",
    subtitle: "Nômades ativos mensais",
    change: "+15.7%",
    icon: Calendar,
    color: "from-orange-500 to-orange-600",
    visible: true,
    description: "Monthly Active Nomads - Nômades ativos no último mês",
  },
  {
    id: "dan",
    title: "DAN",
    value: "127",
    subtitle: "Nômades ativos diários",
    change: "+6.4%",
    icon: TrendingUp,
    color: "from-pink-500 to-pink-600",
    visible: true,
    description: "Daily Active Nomads - Nômades ativos hoje",
  },
]

export function NomadMetricsWidgets() {
  ...
  const exportToPDF = async () => {
    try {
      ...
      doc.text("Dashboard de Métricas de Nômades", 20, 20)
  ...
  return (
    <div className="space-y-2 mt-4">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-foreground">Métricas de Nômades</h2>
          <p className="text-sm text-muted-foreground mt-0.5">Principais indicadores dos profissionais</p>
        </div>
