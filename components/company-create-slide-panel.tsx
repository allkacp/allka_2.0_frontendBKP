      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 app-brand-soft">
          ...
          <Accordion type="single" collapsible className="space-y-2">
            ...
            <AccordionItem value="cadastrais" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
              ...
              <AccordionContent>
                <div className="border-t bg-white/70 px-3 py-3">
            ...
            {/* SEÇÃO 2: CONTATO */}
            <AccordionItem value="contato" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
              ...
              <AccordionContent>
                <div className="border-t bg-white/70 px-3 py-3 grid grid-cols-2 gap-3">
                  <div className="col-span-2 space-y-1">
            ...
            <AccordionItem value="social" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
            ...
            {/* SEÇÃO 4: ENDEREÇO */}
            <AccordionItem value="endereco" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
            ...
            <AccordionItem value="tipoConta" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
            ...
            <AccordionItem value="plano" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
              ...
              <AccordionContent>
                <div className="border-t bg-white/70 px-3 py-3 space-y-3">
                  <div className="space-y-1">
            ...
            <AccordionItem value="pagamento" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
            ...
            <AccordionItem value="admin" className="border border-slate-200 rounded-lg overflow-hidden bg-slate-50/60">
              <AccordionTrigger className="px-3 py-2 hover:bg-slate-100 text-xs font-semibold">
                <div className="flex items-center gap-2">
