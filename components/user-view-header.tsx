...
import { Download, Save, XCircle, X, Eye, EyeOff, Star, Upload, Camera } from "lucide-react"
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    onClick={onClose}
                    disabled={isSaving}
                    className="text-blue-300 hover:text-blue-200 hover:bg-blue-800/50 p-2 rounded-lg transition-colors disabled:opacity-50"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </TooltipTrigger>
